![banner gif](./asset/gif/banner-top.gif)

# ![black cat gif](./asset/gif/black%20cat.gif) **Hey there, I'm Hugo**!

### ![dev gif](./asset/gif/dev.gif) Developer and student.

Welcome to my GitHub profile! Here you'll find the projects I've worked on or am still working on.

## ![link gif](./asset/gif/link.gif) **About me**

🎓 Student in **2nd year post-high school** (for French speakers: **BTS SIO SLAM**) with a passion for everything related to IT development.  
🧑‍💻 I enjoy learning new technologies and deepening my knowledge in development.  
🌐 Learn more on my [portfolio](https://hugo-alves.fr) (french only).
...
![banner gif](./asset/gif/banner-bottom.gif)